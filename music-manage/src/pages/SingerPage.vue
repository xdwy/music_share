  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        <el-button type="danger" size="mini" @click="handleMulDelete" >批量删除</el-button>
    ...
    <el-table size="mini" border ref="multipleTable" style="width: 100%" height="670px" :data="data" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="性别" prop="sex" width="50" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog title="修改歌手" :visible.sync="editVisible" width="400px" center>
      <el-form :model="form" ref="form" label-width="80px">
        ...
        <el-form-item label="性别" size="mini">
          <el-radio-group v-model="form.sex" placeholder="性别">
            <el-radio :label="0">女</el-radio>
            <el-radio :label="1">男</el-radio>
            <el-radio :label="2">组合</el-radio>
            <el-radio :label="3">不明</el-radio>
    ...
    <el-dialog title="删除歌手" :visible.sync="mulDelVisible" width="300px" center>
      <div align="center">删除不可恢复，是否确认删除？</div>
      <span slot="footer">
        <el-button size="mini" @click="mulDelVisible=false">取消</el-button>
...
export default {
  ...
  data () {
    return {
      ...
      mulDelVisible : false, //批量删除弹窗是否显示
      registerForm:{
        // 添加框
        name: '',
        sex: '',
