    ...
    <div>
      ...
      <el-row :gutter="20" class="mgb20">
        <el-col :span="12">
          ...
          <div style = "background-color:white" thems="options">
  ...
  methods: {
    ...
    getSinger(){                        //歌手数量
      getAllSinger().then(res=>{
        ...
        this.singerSex.rows[0]['总数'] = this.setSex('1',res);  //男
        this.singerSex.rows[1]['总数'] = this.setSex('0',res);  //女
        this.singerSex.rows[2]['总数'] = this.setSex('2',res);  //组合
        this.singerSex.rows[3]['总数'] = this.setSex('3',res);  //不明
        for(let item of res){
