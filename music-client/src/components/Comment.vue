  ...
  <div>
    <div class="comment">
      ...
      <div class="comment-msg">
        ...
        <el-input class="comment-input" type="textarea" :row="2" placeholder="请输入内容" v-model="textarea"></el-input>
      </div>
    ...
    <ul class="popular" v-for="(item,index) in commentList" :key = "index">
      <li>
        ...
        <div class="popular-msg">
          <ul>
            <li class="name">用户名：{{userName[index]}}</li>
